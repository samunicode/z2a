    ...
    <footer className="border-t bg-gray-950">
      <div className="container flex flex-col gap-8 py-8 md:flex-row md:py-12">
        <div className="flex-1 space-y-4">
          ...
          <p className="text-sm text-muted-foreground">Transforming careers through quality Python education.</p>
        </div>
      ...
      <div className="container border-t border-gray-800 py-6">
        <p className="text-center text-sm text-muted-foreground">
          © {new Date().getFullYear()} Zero2Advance - All rights reserved.
        </p>
      </div>
    </footer>
  )
